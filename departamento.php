                            ...
                            <div class="single-property-area">
                                ...
                                <?php 
                                    ...
                                    if ($key == 0) {
                                        ...
                                        <img src="images/departamentos/'.$value['imagen'].'" style="width: 750px; height: 392px;" alt="'.$nombre_proyecto.'">
                                        </div> 
                                        ';
                                    } else {
                                        echo '
                                ...
                                if ($key == 0) {
                                    ...
                                    <a class="nav-link" href="#image-'.$key.'" id="image-'.$key.'-tab"
                                        ...
                                        <img src="images/departamentos/'.$value['imagen'].'" alt="'.$nombre_proyecto.'">
                                    </a>
                                    </div>
                                    ';
                                } else {
