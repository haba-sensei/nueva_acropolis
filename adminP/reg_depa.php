                        ...
                        <div class="white_box mb_30">
                            <div class="box_header ">
                                <div class="main-title">
                                    <h3 class="mb-0">Crear Departamento</h3>
                                </div>
                            </div>
                            <form class="update-Form" action="controller/newDepartamento.controlador.php" method="post" role="form" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="texto" class="form-control" name="direccion" id="direccion" placeholder="Ingresa la direccion del departamento">
                                </div>

                                <div class="form-group">
                                    <label for="descripcion">Descripcion</label>
                                    <textarea class="form-control" id="descripcion" name="descripcion" rows="8" placeholder="Ingresa la descripcion del departamento"></textarea>
                                </div>
