                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-12">
                        <div class="white_box mb_30">
                            ...
                            <form class="update-Form" action="controller/editProyecto.controlador.php" method="post" role="form" enctype="multipart/form-data">
                            
                            <?php 
                                while($datos_proyect_Single=mysqli_fetch_assoc($proyectConsEdit)){
                            ...
                            ?>
                            <input type="hidden" name="id_proyect" value="<?=$id_proyecto?>">
