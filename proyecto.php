                    ...
                    <div class="col-lg-4 col-md-8 col-12">
                        <div class="sidebar right-side">
                            ...
                            <aside class="single-side-box video">
                                <div class="aside-title">
                                    <h5>Tipos de departamento</h5>
                                </div>
                                <div class="property-list_2 owl-carousel">

                                    <?php
                                    $depaCons_single_planos = ejecutarSQL::consultar("SELECT `departamentos`.*, `departamentos`.`proyecto_id` FROM `departamentos`  WHERE `departamentos`.`proyecto_id` = '$id_proyecto';");
                                    while ($datos_proyect_planos = mysqli_fetch_assoc($depaCons_single_planos)) {
                                        $img_plano = $datos_proyect_planos['plano'];
                                        $nombre_depa = $datos_proyect_planos['nombre'];
                                        $id_departamento = $datos_proyect_planos['id'];

                                        echo '
                                            <div class="item" > 
                                                <a href="departamento.php?depa=' . $id_departamento . '" class="">  
                                                <img src="images/departamentos/' . $img_plano . '" alt="">
                                                </a>
                                                <br>
                                                <span style="font-size: 18px;
                                                text-transform: capitalize;
                                                font-weight: bold;">' . $nombre_depa . '</span>
                                            </div>
                                            ';
                                    }
                                    ?>
